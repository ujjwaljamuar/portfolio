...
const DsaEditor = () => {
    ...
    const title = useMemo(() => (isEdit ? "Edit Problem" : "New Problem"), [isEdit]);
    ...
    const uploadMarkdownImage = async (e, target, approachIndex = null) => {
        ...
        const uploadKey = approachIndex === null ? target : `${target}-${approachIndex}`;
        ...
        try {
            ...
            if (approachIndex === null) {
                ...
                updateApproach(approachIndex, target, appendMarkdownImage(currentValue, url));
            }
    ...
    if (loading) {
        return <main className="adminPage"><p className="stateText">Loading editor...</p></main>;
    }
        ...
        <main className="adminPage">
            ...
            <form className="editorForm" onSubmit={submitHandler}>
                <section className="editorFields dsaEditorFields">
                    ...
                    <label>
                        Platform
                        <input value={form.platform} onChange={(e) => updateField("platform", e.target.value)} required />
                    </label>
                    <label>
                        Problem URL
                        <input
                    ...
                    <label>
                        Tags
                        <input value={form.tags} onChange={(e) => updateField("tags", e.target.value)} placeholder="array, dp, graph" />
                    </label>
                    <label>
                        Status
